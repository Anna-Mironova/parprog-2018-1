...
#pragma omp task
			{
				P1 = ParallelStrassenAlgorithm(Add(A11, A22, n), Add(B11, B22, n), n, min_size);
			}
#pragma omp task
			{
				P2 = ParallelStrassenAlgorithm(Add(A21, A22, n), B11, n, min_size);
			}
#pragma omp task
			{
				P3 = ParallelStrassenAlgorithm(A11, Sub(B12, B22, n), n, min_size);
			}
#pragma omp task
			{
				P4 = ParallelStrassenAlgorithm(A22, Sub(B21, B11, n), n, min_size);
			}
#pragma omp task
			{
				P5 = ParallelStrassenAlgorithm(Add(A11, A12, n), B22, n, min_size);
			}
#pragma omp task
			{
				P6 = ParallelStrassenAlgorithm(Sub(A21, A11, n), Add(B11, B12, n), n, min_size);
			}
#pragma omp task
			{
				P7 = ParallelStrassenAlgorithm(Sub(A12, A22, n), Add(B21, B22, n), n, min_size);
			}
